...
class ColorTransferApp:
    ...
    def _on_upload_lake_images(self):
        ...
        # self.lake_mean, self.lake_std = utils.get_lake_color_characteristics_single(self.lake_folder_path)
        self.transfer_function = utils.get_lake_color_characteristics_overall(self.lake_folder_path, self.lab_folder_path)
        ...
        if total_images >= 2:
            ...
            for image_path in image_paths:
                ...
                # utils.color_transfer_on_single_image_single(image_path, self.lake_mean, self.lake_std,
                #                                             new_folder_path)

                utils.color_transfer_on_single_image_overall(image_path, self.transfer_function,
                                                             new_folder_path)
                images_processed += 1
